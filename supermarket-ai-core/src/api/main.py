"""FastAPI application (M11 placeholder).
...
def health() -> Dict[str, Any]:
    """Liveness probe. Implemented so deployments can be smoke-tested in M0."""
    return {"status": "ok", "milestone": "M0", "pipeline_implemented": False}


@app.get("/cameras")
def list_cameras() -> Dict[str, Any]:
    """List configured cameras and their topology."""
    raise HTTPException(status_code=NOT_IMPLEMENTED, detail="Not implemented (M11)")
